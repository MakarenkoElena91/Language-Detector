...
import ie.gmit.sw.JH.LanguageEntry;

import java.util.*;

public class Database {
    private  Map<Language, Map<Integer, LanguageEntry>> db = new TreeMap<>();//235 maps  Language -  ngrams - frequency

    public void addDb(CharSequence s, Language lang) {
        int kmer = s.hashCode();
    ...
    public void addQuery(CharSequence s) {
        int kmer = s.hashCode();
    ...
    //give me 1 particular map out of 235 maps
    private Map<Integer, LanguageEntry> getLanguageEntries(Language lang) {//kmer, lang
    ...
    public Language getLanguage(Map<Integer, LanguageEntry> query) {
        ...
        System.out.println(oopm.first().getLanguage());
        return oopm.first().getLanguage();
    }

    public Set getLanguages(Map<Integer, LanguageEntry> query) {
        TreeSet<OutOfPlaceMetric> oopm = new TreeSet<>();
